...
\title{Understanding Task Vectors in Transformers}
\date{\textit{Group Meeting}\\ 2026-03-11}
\author{\large Hao Yan\\}
...
\begin{frame}{Hidden Representations in Neural Network}
